...
public class Sphere {
    ...
    public void loadTexture(Context context, int resourceId) {
        ...
        mTextureDataHandle0 = getTexture(context, resourceId);
    ...
    protected String getVertexShader(Context context) {
        return readTextFileFromRawResource(context,
    ...
    public static int[] getTexture(final Context context, final int resourceId) {
